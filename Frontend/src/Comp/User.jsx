...
import { PlusCircle, Trash2, Edit, X, Users, Search, Shield, Mail, User as UserIcon } from 'lucide-react';
...
function User() {
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      setUsers(response.data); // This line was missing the closing brace
    } catch (error) {
  ...
  const renderRoleBadge = (role) => {
    switch(role) {
      case 'admin':
        return (
          <span className="px-3 py-1 inline-flex items-center text-xs leading-5 font-semibold rounded-full bg-purple-100 text-purple-800">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <button
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg flex items-center transition-colors shadow-md"
          >
          ...
          <div className="bg-white rounded-lg shadow-md p-4">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-3 border border-gray-300 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
              />
            </div>
          </div>
        </div>
